...
abstract class $WeatherCopyWith<$Res> {
  ...
  $Res call({String city, String temp, String main});
}
...
class _$_Weather extends _Weather with DiagnosticableTreeMixin {
  const _$_Weather({required this.city, required this.temp, required this.main})
      : super._();
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Weather(city: $city, temp: $temp, main: $main)';
  }
...
abstract class _Weather extends Weather {
  const factory _Weather(
      ...
      required final String main}) = _$_Weather;
